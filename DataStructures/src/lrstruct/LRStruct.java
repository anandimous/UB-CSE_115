 ...
 * 
 * March 23, 2015
 * Removed unnecessary LRStruct<E> parameters from methods in State hierarchy.
 * 
 */
...
//		_state = (AState<E>) (EmptyState.SINGLETON);  // alternate implementation
	}
	 ...
	 * @throws IllegalStateException if LRStruct is empty.
	 */
	public E getDatum() { return _state.getDatum(); }
	 ...
	 * @throws IllegalStateException if LRStruct is empty.
	 */
	public LRStruct<E> getRest() { return _state.getRest(); }
	...
	private static abstract class AState<E> {
		public void insertFront(LRStruct<E> owner, E item) {
			owner.setState(new NonEmptyState<E>(item,new LRStruct<E>(owner.getState())));
		}
...
//		public static final AState<?> SINGLETON = new EmptyState();
	...
	public interface IAlgo<RETURN_TYPE, ELEMENT_TYPE, INPUT_TYPE> {
		 ...
		 */
		public abstract RETURN_TYPE emptyCase(LRStruct<ELEMENT_TYPE> host, INPUT_TYPE arg);
		 ...
		 * @return The value returned by the visitor.
		 */
		public abstract RETURN_TYPE nonEmptyCase(LRStruct<ELEMENT_TYPE> host, INPUT_TYPE arg);
	}
