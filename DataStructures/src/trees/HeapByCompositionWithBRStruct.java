...
public class HeapByCompositionWithBRStruct<E extends Comparable<E>> implements queues.IQueue<E>{

	private BRStruct<E> _heap;

	public HeapByCompositionWithBRStruct() {
		_heap = new BRStruct<E>();
	}

	@Override public E peek() {
		return _heap.execute(new IAlgo<E,E,Object>(){
			@Override public E emptyCase(BRStruct<E> host, Object _) {
				throw new EmptyQueueException("Cannot 'peek' an empty queue.");
			}
			@Override public E nonEmptyCase(BRStruct<E> host, Object _) {
	...
	@Override public boolean isEmpty() {
		return _heap.execute(new EmptyVisitor<E>(), null);
	}
